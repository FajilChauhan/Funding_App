...
const PaymentPage = ({username}) => {
    ...
    const pay = async (amount) => {
        ...
        var options = {
            ...
            "currency": "INR",
            "name": "Get Me A Book", //your business name
        ...
        return (
            ...
            hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-100
             dark:focus:ring-blue-800 font-medium rounded-lg text-lg px-5 py-2.5 text-center me-2 mb-2" onClick={() => pay(1000)}>Pay ₹10</button>
                                <button className="text-white bg-gradient-to-br from-purple-600 to-blue-600 
            hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300
             dark:focus:ring-blue-800 font-medium rounded-lg text-lg px-5 py-2.5 text-center me-2 mb-2" onClick={() => pay(2000)}>Pay ₹20</button>
                                <button className="text-white bg-gradient-to-br from-purple-600 to-blue-600 
            hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300
             dark:focus:ring-blue-800 font-medium rounded-lg text-lg px-5 py-2.5 text-center me-2 mb-2" onClick={() => pay(3000)}>Pay ₹30</button>
                            </div>
                        </div>
                    </div>
                </div>
