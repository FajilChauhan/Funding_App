...
export const updateProfile = async (formData, originalUsername) => {
  ...
  Object.assign(existingUser, {
    ...
    type: formData.type,
    profilepic: formData.profilepic?.trim() || "https://insidetime.org/wp-content/uploads/2021/10/Handing-in-books.jpg",
    coverpic: formData.coverpic?.trim() || "https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?fit=crop&w=1350&q=80",
